...
// แก้ไขฟังก์ชัน _loadPlotData
  Future<void> _loadPlotData() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('https://sugarcane-9bacy8d0d-suphachais-projects-d3438f04.vercel.app/api/plots/$targetUserId'),
        headers: {"Content-Type": "application/json"},
      );
  ...
  Future<void> _updatePlotData(String plotId) async {
    ...
    final url = Uri.parse('https://sugarcane-9bacy8d0d-suphachais-projects-d3438f04.vercel.app/api/plots/$plotId');
  ...
  Future<void> _deletePlotData(String plotId) async {
    try {
      final response = await http.delete(
        Uri.parse('https://sugarcane-9bacy8d0d-suphachais-projects-d3438f04.vercel.app/api/plots/$plotId'),
        headers: {"Content-Type": "application/json"},
      );
...
// Dialog แสดงผลสำเร็จสำหรับการลบ
  ...
  void _savePlotData() async {
    ...
    final response = await http.post(
      Uri.parse('https://sugarcane-9bacy8d0d-suphachais-projects-d3438f04.vercel.app/api/plots'),
      headers: {"Content-Type": "application/json"},
      body: jsonEncode({
        "userId": widget.userId,
