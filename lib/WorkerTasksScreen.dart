  ...
  Future<void> _fetchTasks() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('https://sugarcane-9bacy8d0d-suphachais-projects-d3438f04.vercel.app/api/plots/tasks/${widget.userId}'),
  ...
  Future<void> _fetchRecommendations() async {
    try {
      ...
      final plotsResponse = await http.get(
        Uri.parse('https://sugarcane-9bacy8d0d-suphachais-projects-d3438f04.vercel.app/api/plots/${widget.userId}'),
          ...
          if (plotId != null && plotId.isNotEmpty) {
            try {
              final recResponse = await http
                  .get(
                    Uri.parse(
                        'https://sugarcane-9bacy8d0d-suphachais-projects-d3438f04.vercel.app/api/plots/$plotId/recommendations'),
                  )
  ...
  Future<List<dynamic>> _fetchRecommendationsForTask(
    ...
    try {
      ...
      final response = await http
          .get(
            Uri.parse('https://sugarcane-9bacy8d0d-suphachais-projects-d3438f04.vercel.app/api/plots/$plotId/recommendations'),
          )
          .timeout(Duration(seconds: 10));
